...
//		PickerEventListener.onCancel -= OnCancel;
	...
	void OnImageSelect(string imgPath)
	{
		...
		if (File.Exists (imgPath)) 
			StartCoroutine (RegistrationWithFacebook.Instance.UploadImage (false, imgPath));

		else
			PopUpManager.instance.ShowPopUp ("UNSUCCESSFULL", "Image Path : " + imgPath);
	}
	...
	void OnError(string errorMsg)
	{
		...
		log += "\nError :" +errorMsg;
		PopUpManager.instance.ShowPopUp ("FAILED", "Error Message : " + errorMsg);
	}
